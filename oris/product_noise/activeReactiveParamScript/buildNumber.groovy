//Below code is to configure buildNumber-activeChoiceReactiveParameter
...
def buildNumbers = data.hits.hits.collect { it._source.pipeline.buildNumber }.unique()

def parameters = []
buildNumbers.each { buildNumber ->
    parameters.add(buildNumber)
}
